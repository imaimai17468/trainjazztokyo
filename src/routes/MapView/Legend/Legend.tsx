  ...
  [
    {
      ...
      instrument: "bass",
      flavor:
        "ウォーキングベースが聴こえます。山手線は東京をぐるりと一周する環状線──終点のない、途切れることのないベースライン。列車が連なると、一つの長い音が円を描いて持続します。",
    },
    {
      code: "JC",
      name: "中央線快速",
    ...
    },
    {
      ...
      instrument: "bass",
      flavor:
        "ウォーキングベースが聴こえます。京浜東北線は大宮から大船まで、首都圏を南北に縦断する大動脈。低く安定したグルーヴが、一日中リズムを刻み続けます。",
    },
    {
      code: "JB",
      name: "中央・総武緩行線",
  ...
  [
    {
      ...
      instrument: "trombone",
      flavor:
        "トロンボーンが聴こえます。浅草線は浅草から羽田空港へ、下町の空気を太い管の音で運ぶ。祭囃子のような賑やかさが、ブラスの奥に聴こえます。列車が長く連なると、音も長く伸びます。",
    },
    {
      code: "S",
      name: "都営新宿線",
      instrument: "trombone",
      flavor:
        "トロンボーンが聴こえます。新宿線は新宿から千葉方面へ、まっすぐ東に伸びる。スライドをゆっくり引くように、長い路線を一息で吹き切ります。",
    },
    {
      code: "E",
      name: "都営大江戸線",
      instrument: "trombone",
      flavor:
        "トロンボーンが聴こえます。大江戸線は都庁の地下深くを巡る大環状線。東京の底を震わせる低音が、街の地盤そのものを鳴らしています。",
    },
  ],
  [
    {
      ...
      flavor:
        "テナーサックスが聴こえます。千代田線は代々木公園の緑を抜けて大手町へ。風が木々の間を吹き抜けるように、サックスのフレーズが呼吸します。列車が途切れると、旋律も息をつきます。",
    },
    {
      code: "Y",
      name: "東京メトロ有楽町線",
      instrument: "saxophone",
      flavor:
        "テナーサックスが聴こえます。有楽町線は金色の路線記号が示すとおり、劇場街のそばを走る。艶やかなアルトの音色が、観客のいない深夜にも鳴り続けます。",
    },
    {
      code: "Z",
      name: "東京メトロ半蔵門線",
      instrument: "saxophone",
      flavor:
        "テナーサックスが聴こえます。半蔵門線は渋谷から押上まで、紫の旋律が都心を横断して下町まで届きます。列車が連なると、フレーズが長く伸びます。",
    },
    {
      code: "N",
      name: "東京メトロ南北線",
      instrument: "saxophone",
      flavor:
        "テナーサックスが聴こえます。南北線は東京で最も静かな路線の一つ。深いブレスで吹くテナーのように、少ない列車が長い音を残します。",
    },
  ],
  [
    {
      ...
      instrument: "celesta",
      flavor:
        "チェレスタが聴こえます。副都心線は東京で最も新しいメトロ路線。渋谷・新宿・池袋──三つの繁華街をつなぐ小さなベル型の鍵盤が、透明な音でネオンの間を縫います。",
    },
    {
      code: "JA",
      name: "埼京線",
  ...
  [
    {
      ...
      instrument: "guitar",
      flavor:
        "ジャズギターが聴こえます。東横線は渋谷から横浜へ、おしゃれな沿線をクリーンなトーンで駆け抜ける。列車が連なると、一つのコード・ヴォイシングになります。",
    },
    {
      code: "DT",
      name: "東急田園都市線",
      instrument: "guitar",
      flavor:
        "ジャズギターが聴こえます。田園都市線は緑の郊外から渋谷へ。朝のラッシュで弦が密に鳴り、深夜は疎らなアルペジオになります。",
    },
    {
      code: "OH",
      name: "小田急小田原線",
      instrument: "guitar",
      flavor:
        "ジャズギターが聴こえます。小田急は新宿から箱根の入口へ。遠くへ向かうストロークが、都心を離れるほど余韻を長く残します。",
    },
    {
      code: "KO",
      name: "京王線",
      instrument: "guitar",
      flavor:
        "ジャズギターが聴こえます。京王線は新宿から高尾山へ。山に向かって鳴るアルペジオが、標高とともに音を薄くしていきます。",
    },
  ],
  [
    {
      ...
      instrument: "rimshot",
      flavor:
        "リムショットが聴こえます。湘南新宿ラインは湘南と都心を結ぶ直通快速──鋭く短い一打が、残響なく消えます。目的を持った往復のように。",
    },
    {
      code: "JU",
      name: "上野東京ライン",
